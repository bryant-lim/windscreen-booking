...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: '3. Booking Appointments';
    pluralName: 'bookings';
  ...
  attributes: {
    ...
    BranchName: Schema.Attribute.Relation<
      'manyToOne',
      'api::branch-data.branch-data'
    >;
    CancellationReason: Schema.Attribute.Text;
    CarPlateNumber: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CurlecTransactionID: Schema.Attribute.String;
    customer: Schema.Attribute.Relation<'manyToOne', 'api::customer.customer'>;
    DepositPaid: Schema.Attribute.Decimal;
    DriverName: Schema.Attribute.String;
    Email: Schema.Attribute.Email;
    ICNumber: Schema.Attribute.String;
    InsuranceFile: Schema.Attribute.Media<'images' | 'files', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    VehicleDetailsJSON: Schema.Attribute.JSON;
  };
}

export interface ApiBranchDataBranchData extends Struct.CollectionTypeSchema {
  collectionName: 'branch_datas';
  info: {
    displayName: '2. Branch Data';
    pluralName: 'branch-datas';
    singularName: 'branch-data';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    BranchPassword: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'123456'>;
    ClosedDaysOfWeek: Schema.Attribute.String;
    Contact: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    LeadTimeMinutes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<120>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::branch-data.branch-data'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    SpecificClosedDates: Schema.Attribute.Text;
    Status: Schema.Attribute.Enumeration<['Active', 'Inactive']> &
      Schema.Attribute.DefaultTo<'Active'>;
    TimeSlots: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    CarPlates: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email: Schema.Attribute.Email;
    FullName: Schema.Attribute.String;
    ICNumber: Schema.Attribute.String & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiVehicleDataVehicleData extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: '1. Vehicle Data';
    pluralName: 'vehicle-datas';
    singularName: 'vehicle-data';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Deposit_Percentage: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<10>;
    Deposit_Required: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vehicle-data.vehicle-data'
    > &
      Schema.Attribute.Private;
